...
<head>
    ...
    <style>
        * {
        ...
        /* Soft Warm Terracotta/Red Cancellation Badge */
        .status-icon {
            width: 64px;
            height: 64px;
            background-color: #FDF3F2; /* Soft muted crimson tint */
            color: #C94B4B;
            border-radius: 50%;
            display: inline-flex;
            align-items: center;
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Real-time pipeline confirmation for active room allocations.</p>
            </div>
        ...
        <!-- Success Cancellation Alert Box Panel -->
        <div class="card-wrapper">
            <div class="status-card">
                <div class="status-icon">✕</div>
                <h2>Reservation Cancelled</h2>
                <p>The selected room booking has been successfully revoked and removed from the active processing database queue. The vacancy updates will reflect instantly across client channels.</p>
