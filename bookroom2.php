...
<head>
    ...
    <style>
        * {
        ...
        /* Modern Check/Success Icon Indicator */
        .success-icon {
            width: 64px;
            height: 64px;
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Track your submission records and verification stages.</p>
            </div>
        ...
        <div class="card-wrapper">
            <div class="success-card">
                ...
                <p>Your room booking request has been successfully received. Please wait while our administrative team reviews and confirms your reservation request.</p>
