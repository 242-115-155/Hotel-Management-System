...
<head>
    ...
    <style>
        * {
        ...
        /* Set Confirmed Bookings as Active link */
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            ...
            <p>View currently checked-in guests and manage their stay schedule.</p>
        </div>

        <!-- Centered Container Area -->
        <div class="box-wrapper-centered">
            <div class="basic_box">
                <h2 class="table-title">Confirmed Bookings</h2>
                ...
                <h3 class="section-subtitle">Modify Stay</h3>

                <!-- Modify Stay Form Section -->
                <form action="admin_modify_room.php" method="post">
                    <table class="modify-form">
                        <tr>
                            <td class="form-label"><label for="book_id"><b>Enter Booking ID:</b></label></td>
                            <td>
                                <input type="number" name="book_id" id="book_id" placeholder="e.g. 1045" required>
                            </td>
                        </tr>
                        <tr>
                            <td class="form-label"><label for="checkout"><b>Enter new Check-Out date:</b></label></td>
                            <td>
                    ...
                    <div class="submit-container">
                        <button type="submit">Change Stay Dates</button>
                    </div>
                </form>
            </div>
        </div>
