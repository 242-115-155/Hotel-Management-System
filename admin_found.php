...
<head>
    ...
    <title>Terminal Recovered - NS Grand Hotel</title>
    ...
    <style>
        * {
        ...
        /* Password Recovery Info Card for Admin */
        .recovery-card {
            background: #FFFFFF;
            border-radius: 24px;
            padding: 50px 40px;
        ...
        /* Admin Style Lock/Security Icon Circle */
        .icon-wrapper {
            width: 64px;
            height: 64px;
            background-color: #EBECEE; /* Admin slate tint */
            color: #1F2223;
            border-radius: 50%;
            display: flex;
            align-items: center;
        ...
        .btn-redirect {
            display: block;
            background-color: #1F2223; /* Admin Dark Theme */
            color: #E5D5C5;
...
<body>
    ...
    <div class="recovery-card">
        ...
        <h2>Terminal Found</h2>
        <p>Administrative verification successful. Below is the registered terminal password associated with your Employee ID.</p>

        <!-- Dynamic Password Fetching Area -->
        <div class="password-display-box">
            <span class="password-label">Your Admin Password is</span>
        ...
        <!-- Redirect Button -->
        <a href="admin_login.php" class="btn-redirect">Redirect to Admin Login</a>
    </div>
