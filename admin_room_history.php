...
<head>
    ...
    <title>Admin - Booking Details History</title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <p>Review the comprehensive log and services chosen for this reservation.</p>
        </div>
        ...
        <div class="table-wrapper-centered">
            <div class="table-container">
                <h2 class="table-title">Reservation Summary</h2>

                <?php if ($row): ?>
                    <!-- If data exists, display table -->
                ...
                <?php else: ?>
                    <!-- If page accessed directly or invalid ID -->
                    <p class="error-message">No valid booking ID specified. Please access this page from the Booking History menu.</p>
                <?php endif; ?>

                <div class="card-actions">
                    <a href="booking_history.php" class="btn-back">Back to History</a>
                </div>
            </div>
        </div>
    </div>
