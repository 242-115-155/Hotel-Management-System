...
<head>
    ...
    <title>NS Grand Hotel - Admin SignUp</title>
    ...
    <style>
        * {
        ...
        .brand-panel {
            width: 45%;
            background-color: #1F2223; /* Dark slate/charcoal for corporate admin feel */
            color: #FFFFFF;
            padding: 45px;
            display: flex;
        ...
        /* Right Side: Clean Admin SignUp Panel */
        .form-panel {
            width: 55%;
            padding: 55px 50px;
            display: flex;
...
<body>
    ...
    <div class="login-master-card">
        ...
        <!-- RIGHT SIDE PANEL: Admin SignUp Form -->
        <div class="form-panel">
            <div class="form-header">
                <span>MANAGEMENT REGISTRATION</span>
                <h3>Admin SignUp</h3>
                <p>Register administrative credentials below to initialize access.</p>
            </div>
