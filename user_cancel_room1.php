...
<head>
    ...
    <title>Booking Cancelled Successfully</title>
    ...
    <style>
        * {
        ...
        /* Modern Check/Info Icon Indicator */
        .success-icon {
            width: 64px;
            height: 64px;
            background-color: #FCEFEF; /* Soft light red/crimson tint */
            color: #C94B4B;
            border-radius: 50%;
            display: inline-flex;
            align-items: center;
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Acknowledgment for your booking cancellation request.</p>
            </div>
        ...
        <!-- Success Acknowledgment Card Layout -->
        <div class="card-wrapper">
            <div class="success-card">
                <div class="success-icon">✕</div>
                <h2>Booking Cancelled!</h2>
                <p>Your room booking request has been cancelled successfully. Any pre-authorized processing for this specific reservation record has been halted.</p>
