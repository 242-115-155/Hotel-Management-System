...
<head>
    ...
    <title>Admin - Room Updated</title>
    ...
    <style>
        * {
        ...
        /* Active highlight kept on Rooms Info as per requirement */
        ...
        /* Centered White Box/Card styling matching screenshot 3d50ca80-aaea-4f13-a962-e174b69ab54f */
        .table-container {
            background: #FFFFFF;
            border-radius: 20px;
            padding: 50px 55px;
        ...
        /* Dark Elegant Action Button matching your mockup */
        .btn-redirect {
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="table-container">
            ...
            <h2 class="table-title">Update Successful</h2>
            <p class="success-text">Admin Room Check-out date is updated successfully inside the system.</p>
            
            <a href="admin_view.php" class="btn-redirect">Return to Rooms Info</a>
        </div>
