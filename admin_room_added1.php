...
<head>
    ...
    <style>
        * {
        ...
        /* Active highlight kept on Add Room as this page confirms that action */
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="table-container">
            ...
            <h2 class="table-title">Room Added</h2>
            <p class="success-text">Admin Room has been added successfully to the hotel inventory records.</p>
