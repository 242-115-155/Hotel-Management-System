...
<head>
    ...
    <style>
        * {
        ...
        /* Set Remove Rooms as Active link */
        ...
        .basic_box {
            ...
            border-radius: 20px;
            padding: 45px 55px;
            width: 1000px; /* Matching the exact size of previous table boxes */
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <h1>Remove Rooms</h1>
            <p>Manage and reduce hotel room inventory safely.</p>
        </div>
        ...
        <div class="box-wrapper-centered">
            <div class="basic_box">
                ...
                <!-- Remove Room HTML Form Section -->
                <form action="admin_room_removed.php" method="post">
                    <table class="form-table">
                        ...
                        <tr>
                            <td class="form-label"><label for="rooms_input"><b>Enter number of rooms to remove:</b></label></td>
                            <td>
                                <input type="number" min="0" name="noofrooms" id="rooms_input" placeholder="e.g. 2" required>
                            </td>
                        </tr>
                    </table>
